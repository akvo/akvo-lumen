(defproject org.akvo/lumen "0.24.0-SNAPSHOT"
  ...
  :dependencies [[clojurewerkz/scrypt "1.2.0"]
                 ...
                 [honeysql "0.9.3"]
                 [meta-merge "1.0.0"]
                 [metosin/reitit "0.2.12" :exclusions [org.clojure/spec.alpha org.ow2.asm/asm ring/ring-core mvxcvi/puget ring/ring-codec org.clojure/core.rrb-vector fipp r com.fasterxml.jackson.core/jackson-databind com.fasterxml.jackson.core/jackson-core]]
