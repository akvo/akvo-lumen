...
(s/def ::transformation.engine.s/op-spec
...
(s/def ::transformation.derive-category.derivation.text/mappings (s/coll-of (s/tuple (s/coll-of string? :kind vector? :min-count 1) string?) :kind vector? :min-count 1))
