(ns akvo.lumen.lib.transformation.engine-test
  {:functional true}
  (:require [akvo.lumen.fixtures :refer [migrate-tenant rollback-tenant summarise-transformation-logs-fixture tenant-conn-fixture *tenant-conn* system-fixture system-config-fixture]]
...
(use-fixtures :once system-config-fixture system-fixture tenant-conn-fixture fixture summarise-transformation-logs-fixture tu/spec-instrument)
