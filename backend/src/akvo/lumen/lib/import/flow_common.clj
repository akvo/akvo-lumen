...
(defn questions-responses-current-implementation
...
(defn questions-responses-with-rqg-in-one-column
  "Returns a map from question-id to response"
...
(defn question-responses
  ...
  [environment questions responses]
  (if (first (get environment "rqg"))
    (questions-responses-with-rqg-in-one-column environment questions responses)
    (questions-responses-current-implementation responses)))
