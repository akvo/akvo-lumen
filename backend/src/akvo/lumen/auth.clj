...
(defmethod ig/init-key :akvo.lumen.auth/wrap-auth  [_ {:keys [keycloak-public-client auth0-public-client]}]
  (wrap-auth keycloak-public-client auth0-public-client))
...
(defmethod ig/init-key :akvo.lumen.auth/wrap-jwt  [_ {:keys [keycloak-public-client auth0-public-client]}]
  (wrap-jwt keycloak-public-client auth0-public-client))
