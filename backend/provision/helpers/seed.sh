...
# Setup tenant db 1
psql -c "
CREATE DATABASE test_dash_tenant_1
WITH OWNER = dash
     TEMPLATE = template0
     ENCODING = 'UTF8'
     LC_COLLATE = 'en_US.UTF-8'
...
psql -d test_dash_tenant_1 -f $DIR/tardis.sql

# Setup tenant db 2
psql -c "
CREATE DATABASE test_dash_tenant_2
WITH OWNER = dash
     TEMPLATE = template0
     ENCODING = 'UTF8'
     LC_COLLATE = 'en_US.UTF-8'
...
psql -d test_dash_tenant_2 -f $DIR/tardis.sql
